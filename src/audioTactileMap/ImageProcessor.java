...
class ImageProcessor {
  ...
  ImageProcessor(PApplet parent_, String iPath_) { //Initialise with path to file
    parent=parent_;
    imagePath= iPath_;
  }

  //  ImageProcessor(PImage pImg_) { ////Initialise with image file
  //    processImg= pImg_;
  //  } 
  ...
  void scanForBlobs() {
    ...
    //    System.out.println("Blobs found in "+(millis()-segmentationStartTime)+" ms"); 
